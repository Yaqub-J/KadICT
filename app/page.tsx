          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row gy-5">
              <div className="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
                ...
                <div>
                  <h4 className="title"><Link href="#" className="stretched-link">ERP Systems</Link></h4>
              ...
              <div className="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h4 className="title"><Link href="#" className="stretched-link">Training</Link></h4>
              ...
              <div className="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="300">
                ...
                <div>
                  <h4 className="title"><Link href="#" className="stretched-link">Software Testing</Link></h4>
              ...
              <div className="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="400">
                ...
                <div>
                  <h4 className="title"><Link href="#" className="stretched-link">Blockchain Lab</Link></h4>
              ...
              <div className="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="500">
                ...
                <div>
                  <h4 className="title"><Link href="#" className="stretched-link">Incubation & Accelleration</Link></h4>
              ...
              <div className="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="600">
                ...
                <div>
                  <h4 className="title"><Link href="#" className="stretched-link">Big Data & Cyber-security</Link></h4>
